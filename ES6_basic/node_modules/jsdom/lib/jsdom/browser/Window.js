...
const createXMLHttpRequest = require("jsdom/lib/jsdom/living/xmlhttprequest.js");
const createFileReader = require("jsdom/lib/jsdom/living/generated/FileReader.js").createInterface;
const createWebSocket = require("jsdom/lib/jsdom/living/generated/WebSocket.js").createInterface;
...
const createAbortController = require("jsdom/lib/jsdom/living/generated/AbortController.js").createInterface;
const createAbortSignal = require("jsdom/lib/jsdom/living/generated/AbortSignal.js").createInterface;
const reportException = require("jsdom/lib/jsdom/living/helpers/runtime-script-errors.js");
const { matchesDontThrow } = require("jsdom/lib/jsdom/living/helpers/selectors.js");
...
const dom = require("jsdom/lib/jsdom/living.js");

const cssSelectorSplitRE = /((?:[^,"']|"[^"]*"|'[^']*')+)/;

const defaultStyleSheet = cssom.parse(require("jsdom/lib/jsdom/browser/default-stylesheet.js"));
